...
// 読み込み位置は </body> の直前で defer なし（本文DOMが揃ってから走る従来の順序）。
    ...
    function validateCell(cell) {
        ...
        //
        // しきい値はワンノート板金部の実測から（2026-09-01・上位5%は無視する方針）:
        //   品名（ページ名770件）… p95=19字・最大32字
        //   図面番号（260値）    … p95=18字・最大46字（外れ値1件）
        // → 20字なら95%の品名・図面番号が1行に収まり、突出した5%だけが折り返す
        //   ——「突出したもののために全体が長くなりすぎること」を避ける。
        const ATOMIC_MAX = 20;
