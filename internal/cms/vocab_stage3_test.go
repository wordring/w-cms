...
func TestClientOrderFromSection(t *testing.T) {
	...
	body := `<section data-type="file" data-src="po.pdf"><p>📎 <a href="/data/master/00/000050/po.pdf">発注書.pdf</a></p>` +
		...
		`<dt>発注元</dt><dd data-field="client-name">南北</dd>` +
	...
	if clientName != "南北" || pdfPath != "po.pdf" {
...
func TestEstimatesFromDL(t *testing.T) {
	...
	body := `<dl data-type="our-estimate"><dt>品番</dt><dd data-field="item-id">SHAFT-01</dd>` +
		`<dt>顧客</dt><dd data-field="client-name">南北</dd>` +
...
func TestMigrateStage3Equivalence(t *testing.T) {
	...
	body := `<h1>受注ページ</h1>` +
		...
		`<m-client-order order-no="PO-B200" client-name="南北" ordered-at="2026-06-18">` +
		...
		`</m-supplier-order>` +
		`<m-our-estimate item-id="SHAFT-01" client-name="南北" price="12000" estimated-at="2026-06-01"></m-our-estimate>` +
