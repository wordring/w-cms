...
//
// 実データで踏んだ誤爆（2026-09-04）: 顧客の発注書番号 `250401-203`
// （26年06月02日＋連番）は「6桁＋ハイフン＋英数字」という参照値の文法に
// **そのまま当てはまり**、「参照先のページ 250401 が見つかりません」の薄赤が
