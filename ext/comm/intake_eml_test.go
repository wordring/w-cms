...
func TestEmlIntakeSplitsAddresses(t *testing.T) {
	...
	for _, want := range []string{
		"<dt>差出人</dt><dd>潮崎 光俊 &lt;shiozaki@example.co.jp&gt;</dd>",
		"<dt>宛先</dt><dd>南 様 &lt;minami@i-toho.co.jp&gt;</dd>",
	...
	for _, pair := range [][2]string{
		{"差出人", "shiozaki@example.co.jp"},
		{"宛先", "minami@i-toho.co.jp"},
