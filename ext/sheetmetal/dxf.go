...
// （実物の図面で確認: `P103-227-6` / `台座Assy(溶接図）` / `装置A
...
// ばらつき、狭い窓では PFC2・M305 の表題欄が丸ごと空振りしました。
//
...
// ——実際の値は数字を含む（`P103-227-6`・`1`・`2024.09.26`）か、和文を含みます
// （`台座Assy(溶接図）`・`5.3㎏`）。英字だけの値（`ZINC` 等）は取りこぼしますが、
