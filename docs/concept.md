...
<body>
    ...
    <m-client-order item-id="P103-123-2" item-name="ﾓｰﾀｰｶｯﾌﾟﾘﾝｸﾞ" price="3500" quantity="20"></m-client-order>
...
*   `value` (TEXT): 属性の値 (例: `"株式会社南北スポーツ機械"`, `"2026-06-10"`, `"通常"`)
